...
import 'package:tugas9_010/page/settings.dart';
import 'package:tugas9_010/utils/quick_box.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Image.asset('assets/word.png', fit: BoxFit.cover),
        centerTitle: true,
        elevation: 0,
        actions: [
          Consumer<Controller>(
              ...
              if (notifier.gameCompleted) {
                if (notifier.gameWon) {
                  if (notifier.currentRow == 6) {
                    ...
                    runQuickBox(context: context, message: 'Sheeshh!');
                  }
                } else {
